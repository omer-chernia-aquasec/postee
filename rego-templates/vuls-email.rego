  ...
  <div class="container">
    <div class="section-container">
      ...
      <table border="0" cellpadding="0" cellspacing="5" align="center" style="margin: 0 auto; border-collapse:separate; border-spacing:5px;">
        <tr>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#bb0505" style="width:135px; height:95px; min-width:135px; max-width:135px; min-height:95px; max-height:95px; background-color:#bb0505; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; mso-line-height-rule:exactly; line-height:95px; padding:0;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ff0036" style="width:135px; height:95px; min-width:135px; max-width:135px; min-height:95px; max-height:95px; background-color:#ff0036; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; mso-line-height-rule:exactly; line-height:95px; padding:0;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ff8e50" style="width:135px; height:95px; min-width:135px; max-width:135px; min-height:95px; max-height:95px; background-color:#ff8e50; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; mso-line-height-rule:exactly; line-height:95px; padding:0;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ffbf50" style="width:135px; height:95px; min-width:135px; max-width:135px; min-height:95px; max-height:95px; background-color:#ffbf50; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; mso-line-height-rule:exactly; line-height:95px; padding:0;">%d</td>
