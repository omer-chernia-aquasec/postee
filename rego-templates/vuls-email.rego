...
<body>
  <table border="0" cellpadding="0" cellspacing="0" width="100%%" style="margin:50px 0;">
    <tr>
  ...
  <div class="properties-container">
    <div class="properties-row">
      <div class="properties-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">%s name:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
      <div class="properties-cell left-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">Malware found:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
    </div>
    <div class="properties-row">
      <div class="properties-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">Registry:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
      <div class="properties-cell left-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">Sensitive data found:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
    </div>
    <div class="properties-row">
      <div class="properties-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">%s</span>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="section-container">
      <div class="vulnerabilities-summary form-header" style="color:#183278; font-family:'Poppins-SemiBold', Arial, sans-serif; font-size:20px; font-weight:600; margin-top:60px; margin-bottom:15px; margin-left:5px;">Vulnerabilities summary</div>
      <table border="0" cellpadding="0" cellspacing="5" align="center" style="margin: 0 auto; border-collapse:separate; border-spacing:5px;">
        <tr>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#bb0505" style="width:135px; height:95px; min-width:135px; max-width:135px; background-color:#bb0505; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; padding:35px 10px; mso-line-height-rule:exactly; line-height:95px;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ff0036" style="width:135px; height:95px; min-width:135px; max-width:135px; background-color:#ff0036; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; padding:35px 10px; mso-line-height-rule:exactly; line-height:95px;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ff8e50" style="width:135px; height:95px; min-width:135px; max-width:135px; background-color:#ff8e50; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; padding:35px 10px; mso-line-height-rule:exactly; line-height:95px;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#ffbf50" style="width:135px; height:95px; min-width:135px; max-width:135px; background-color:#ffbf50; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; padding:35px 10px; mso-line-height-rule:exactly; line-height:95px;">%d</td>
          <td align="center" valign="middle" width="135" height="95" bgcolor="#a9e4f0" style="width:135px; height:95px; min-width:135px; max-width:135px; background-color:#a9e4f0; border-radius:4px; color:#ffffff; font-family:'Poppins-Medium', Arial, sans-serif; font-size:28px; font-weight:bold; padding:35px 10px; mso-line-height-rule:exactly; line-height:95px;">%d</td>
        </tr>
      </table>
    </div>
    <div class="section-container">
      <div class="assurance-controls form-header" style="color:#183278; font-family:'Poppins-SemiBold', Arial, sans-serif; font-size:20px; font-weight:600; margin-top:60px; margin-bottom:15px; margin-left:5px;">Assurance controls</div>
      <table class="assurance-controls-table">
        <tr class="assurance-controls-table-header" style="background-color:#ebf3fa; border-bottom:1px solid #183278;">
          <th style="color:#183278; font-family:'Inter-SemiBold', Arial, sans-serif; font-size:13px; font-weight:600; padding:6px; text-align:left;">#</th>
          <th style="color:#183278; font-family:'Inter-SemiBold', Arial, sans-serif; font-size:13px; font-weight:600; padding:6px; text-align:left;">Control</th>
          <th style="color:#183278; font-family:'Inter-SemiBold', Arial, sans-serif; font-size:13px; font-weight:600; padding:6px; text-align:left;">Policy Name</th>
          <th style="color:#183278; font-family:'Inter-SemiBold', Arial, sans-serif; font-size:13px; font-weight:600; padding:6px; text-align:left;">Status</th>
        </tr>
        %s
      </table>
    </div>
  ...
  <div class="properties-container">
    <div class="properties-row">
      <div class="properties-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">Response policy name:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
    </div>
    <div class="properties-row">
      <div class="properties-cell">
        <span class="cell-header" style="color:#6b7887; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; padding-right:15px;">Response policy application scopes:</span>
        <span class="cell-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400;">%s</span>
      </div>
    </div>
  </div>
  <div class="see-more-container">
    <a href="%s" class="see-more" style="color:#2f3fb7; text-align:center; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:15px; font-weight:400; border:1px solid #2f3fb7; border-radius:4px; width:103px; height:45px; display:inline-block; line-height:45px; text-decoration:none;">See more</a>
  </div>
</body>
</html>
`

cell_tpl:=`<td style="padding:6px; color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:14px; font-weight:400;">%s</td>`

row_tpl:=`
<tr class="assurance-controls-content" style="color:#405a75; font-family:'Helvetica-Regular', Arial, sans-serif; font-size:14px; font-weight:400;">
%s
</tr>`
...
logo := `<img
           ...
           alt="aqua"
           style="display:block; width:123px; height:35px; border:0; max-width:123px;"
         />`
